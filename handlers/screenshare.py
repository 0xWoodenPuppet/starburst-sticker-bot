...
async def handle_screenshare(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    try:
        ...
        if member.status in ("left", "kicked", "banned"):
            await _safe_reply(msg, "❌ Please join the channel first. @NotebookOfBilal")
            return
    except TelegramError as e:
    ...
    try:
        ...
        await _safe_reply(msg, "⚠️ You already have permission to share your screen/cam in @NotebookOfBilal!")
        return
    ...
    await _safe_reply(msg, "🎥 You can now share your screen/cam in @NotebookOfBilal! Please do not click on 'End live stream' when leaving.\n \n 🎥 يمكنك الآن مشاركة شاشتك/كاميرتك في القناة! يُرجى عدم النقر على 'إنهاء البث المباشر' عند المغادرة.")   
