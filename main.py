...
# # 2. ADMIN USER IDs
# # To find a user ID, message @userinfobot on Telegram.
...
#         # --- MODIFICATION START ---
#         # Only proceed if the Forest app URL is in the message
#         if 'https://www.forestapp.cc' not in text:
#             return
#         # --- MODIFICATION END ---
